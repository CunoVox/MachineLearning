...
mydict = ['BanKiet', 'BanNghia',  'BanThanh', 'HoanHao', 'SangSang', 'ThayDuc']
...
def visualize(input, faces, fps, thickness=2):
    if faces[1] is not None:
        for idx, face in enumerate(faces[1]):
            ...
            cv.putText(input, result, (coords[0], coords[1] - 7), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    ...
    cv.putText(input, 'FPS: {:.2f}'.format(fps), (1, 16), cv.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
